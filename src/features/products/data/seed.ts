...
export const seedProducts: SeedProduct[] = [
  ...
  },
  {
    ...
    description: {
      ...
      ar: 'تختار داليا وتحصد لكم أجود عسل من الغابات الإسبانية الكبيرة. هذا العسل الداكن ذو النكهة الخشبية يضمن التتبع الكامل: أصل معتمد ونقاء مُراقَب بدقة. خشبي وكريمي بحلاوة لا مثيل لها. أصل إسبانيا.',
    },
    slug: 'miel-foret',
    price: 1490,
  ...
  },
  {
    ...
    description: {
      ...
      ar: 'يُزرع أساساً في إسبانيا، يأتي عسل الغريك من أراضٍ منتقاة بعناية حيث تتجول النحلات في السهول. نكهات الزعتر وإكليل الجبل تجعله كنزاً طبيعياً. مثالي للتناول العائلي. أصل إسبانيا.',
    },
    slug: 'miel-garrigue',
    price: 1390,
  ...
  },
  {
    ...
    description: {
      ...
      ar: 'العسل أحد أثمن كنوز الخلية. عسل متعدد الأزهار لدينا، مثالي لمحبي النكهات الأصيلة، يأتي من أراضٍ إسبانية منتقاة بعناية. كريمي وبحلاوة لا مثيل لها. أصل إسبانيا.',
    },
  ...
  },
  {
    ...
    description: {
      ...
      ar: 'يُحصد في التلال الإسبانية العطرة بإكليل الجبل البري. معروف بفوائده المهدئة والهضمية. كل قطرة تعكس أرضاً محفوظة تقدم نكهات فريدة وثروة غذائية لا مثيل لها. أصل إسبانيا.',
    },
    slug: 'miel-romarin',
    price: 1490,
